...
def build_centralized_long_prefill_10_cluster_config() -> SimulationConfig:
    distributed_clusters = []
    long_prefill_instance_count = 10
    ...
    central_cluster = cluster(
        ...
        pools=[
            pool(
                "central-long-prefill",
                ResourceKind.LONG_PREFILL,
                long_prefill_instance_count,
                1,
            )
        ],
    )
    ...
    return SimulationConfig(
        ...
        scenario=ScenarioConfig(
            name="centralized-long-prefill-10-clusters-global-summary",
        ...
        logging=LoggingConfig(
            ...
            log_to_file=False,
            log_file_path=None,
            logger_name="cen_dis_sim.case.centralized_long_prefill_10_clusters",
        ),
    )
...
def main() -> None:
    ...
    config = build_centralized_long_prefill_10_cluster_config()

...
def build_distributed_10_cluster_config() -> SimulationConfig:
    clusters = []
    ...
    return SimulationConfig(
        ...
        scenario=ScenarioConfig(
            name="distributed-10-clusters-global-summary",
            clusters=clusters,
        ...
        logging=LoggingConfig(
            ...
            log_to_file=False,
            log_file_path=None,
            logger_name="cen_dis_sim.case.distributed_10_clusters",
        ),
    )
...
def main() -> None:
    ...
    config = build_distributed_10_cluster_config()

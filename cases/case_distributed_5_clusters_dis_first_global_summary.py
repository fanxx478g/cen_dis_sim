...
def build_distributed_5_cluster_dis_first_config(
    ...
    logging_config = LoggingConfig(
        ...
        log_to_file=False,
        log_file_path=None,
        logger_name="cen_dis_sim.case.distributed_5_clusters_dis_first",
    )
    ...
    return SimulationConfig(
        ...
        scenario=ScenarioConfig(
            name="distributed-5-clusters-dis-first-global-summary",
            clusters=clusters,
...
def main() -> None:
    ...
    config = build_distributed_5_cluster_dis_first_config()

...
from cases.case_centralized_long_prefill_2_clusters_global_summary import (
    build_centralized_long_prefill_2_cluster_config,
)
from cases.case_distributed_2_clusters_global_summary import (
    build_distributed_2_cluster_config,
)
...
def build_request_generation_overrides(params: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "short_context_probability": 1.0 - long_context_ratio,
...
def scenario_builders():
    return {
        "distributed_2_clusters": build_distributed_2_cluster_config,
        "centralized_long_prefill_2_clusters": (
            build_centralized_long_prefill_2_cluster_config
        ),
    }
...
def main() -> None:
    ...
    summary_rows = collect_batch_log_rows()
    if summary_rows:
